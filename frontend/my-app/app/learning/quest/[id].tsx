...
import mockQuizData from '../../../app/services/mockQuizData';
...
export default function QuestScreen() {
  ...
  const quizData = id ? mockQuizData[id.toString() as keyof typeof mockQuizData] || backupQuizData[id.toString() as keyof typeof backupQuizData] : null;
